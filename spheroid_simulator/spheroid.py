...
class Spheroid:
    ...
    def __init__(self, centroid, neuron_number, cover_angle, min_radius, max_radius, offset_delta, division_nb):
    ...
    def create_neurons(self):
        for _ in range(self.neuron_number):
            ...
            n = Neuron(neuronino.startPoint, neuronino.endPoint, self.offset_delta, self.division_nb, random.randint(10,200))
            n.make_neuron()
